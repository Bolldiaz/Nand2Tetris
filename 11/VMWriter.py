...
"""
import typing
CONST, ARG, LOCAL, STATIC, THIS, THAT, POINTER, TEMP = "CONST", "ARG", "LOCAL", "STATIC", \
                                                       "THIS", "THAT", "POINTER", "TEMP"
SEGMENT_DICT = {"CONST": "constant", "ARG": "argument", "VAR": "local", "STATIC": "static", "FIELD": "this",
...
class VMWriter:
    ...
    def write_push(self, segment: str, index: int) -> None:
        ...
        """
        self.output_stream.write(f"push {SEGMENT_DICT[segment]} {index}\n")
    ...
    def write_pop(self, segment: str, index: int) -> None:
        ...
        """
        self.output_stream.write(f"pop {SEGMENT_DICT[segment]} {index}\n")
